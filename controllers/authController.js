...
exports.signup = async (req, res, next) => {
    try {
        ...
        const userType = (req.params.type.toLowerCase() == 'curier') ? "Curier" : "Client"
        const newUser = await models.users.create({ userEmail: req.body.userEmail, userPassword, userType});
        if (!newUser)
            return
